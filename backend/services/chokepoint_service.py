...
CHOKEPOINTS = {
    "hormuz": {
        ...
        "current_threat": "2-week ceasefire in effect (April 8-22). Ships resuming transit. Fragile — Lebanon NOT included, Iran attacked Gulf states on Day 1. Islamabad talks April 10.",
        "ceasefire": {
            "active": True,
            ...
            "fragile": True,
            "risk_factors": [
                "Lebanon NOT included — Israel continues strikes",
                "Iran attacked Kuwait/UAE on Day 1",
                "Negotiations in Islamabad April 10",
            ],
            "ships_transiting": True,
            "collapse_probability": 35,
            "collapse_triggers": [
                "Israel strikes Lebanon/Iran",
                "Iran resumes Hormuz blockade",
                "Islamabad talks fail (April 10)",
                "US/Iran accuse each other of violations",
            ],
